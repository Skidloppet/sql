    ...
    <div class="w3-container w3-padding w3-margin w3-border-top">
      ...
      <div class="w3-left w3-content">
       ...
       <form id="radKomEnt">
        ...
        <button type="button" onclick="SendForm('comments','comments','radKomEnt');" class="HoverButton" >Skicka</button>
      </form></br>
    ...
    <div class="w3-container w3-padding w3-margin w3-border-top">
      ...
      <div class="w3-left w3-content">
       ...
       <form id="radDelEnt">
        ...
        <button type="button" onclick="SendForm('comments','comments','radDelEnt');" class="HoverButton" >Skicka</button>
      </form></br>
